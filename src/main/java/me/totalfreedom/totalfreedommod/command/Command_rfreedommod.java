...
@CommandParameters(description = "Shows information about RFreedomMod or reloads it", usage = "/<command> [reload]", aliases = "rfm,decyi")
public class Command_rfreedommod extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        msg("RFreedomMod for 'R Freedom', a all-op server.", ChatColor.GOLD);
        msg("Running on " + ConfigEntry.SERVER_NAME.getString() + ".", ChatColor.GOLD);
        msg("Created by decyj145.", ChatColor.GOLD);
        ...
        msg("Visit " + ChatColor.AQUA + "https://github.com/Decyj145/RFreedomMod-V2.0/"
